...
#
#### Convert the highest weight from the base of coroots to the base of the
#### ambient space.
#### XXX: This is true only for A-type.
#highest_weight_internal = sum(
#    [x * fund_wts[i+1] for i, x in enumerate(highest_weight_list)]
#)
#
...
#### Weight data is given as a dictionary with the following format
#### {... , weight : multiplicity , ...}
#print(rep.weight_multiplicites())
#
