...
#    print("Press Ctrl+C to quit")
    ...
    application1 = MyApplication(figure1)

    http_server0 = tornado.httpserver.HTTPServer(
        application0, xheaders=True,
    )
    http_server1 = tornado.httpserver.HTTPServer(
        application1, xheaders=True,
    )

    http_server0.listen(8080)
    http_server1.listen(8081)

    print("http://127.0.0.1:808x/")
    print("Press Ctrl+C to quit")
